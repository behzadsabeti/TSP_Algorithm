...
def powerset(s: list):                         # a function which returns subsets of a list from https://stackoverflow.com/a/1482316/12466594
...
def travel(n: int, W: list, V: list):                # main function, n: number of vertices, W: Adjacency Matrix, V: vertices
    ...
    subsets_v = powerset(V)                         # make all subsets of vertices
